...
As a Cupid, you are the backbone of the Cupid Code platform. Your role is to help Daters by delivering items and providing assistance during their dates. You earn money by completing gigs, and you can build a strong reputation through quality service and positive ratings.

#### Cupid Table of Contents
- [Accessing the Cupid Dashboard](#accessing-the-cupid-dashboard) - Learn how to navigate the main Cupid interface
...
- [Cupid Profile](#cupid-profile) - Update your profile information and payment details

#### Key Cupid Responsibilities:
- **Finding Gigs**: Browse and claim available gigs from Daters
- **Completing Tasks**: Pick up items and deliver them to specified locations on time
- **Building Reputation**: Maintain high quality service to earn positive ratings
- **Managing Payments**: Keep your PayPal email updated to receive earnings
...
![Manager dashboard with navigation menu showing main options](images/Manager-dashboard-navigation.png)
...
![Dashboard popup navigation](images/Manager-dashboard-popup.png)
...
![Analytics dashboard with statistical graphs and charts](images/Manager-dashboard-graph.png)
...
![Export functionality for downloading reports](images/Manager-dashboard-export.png)
...
![Dater management page showing list of registered daters](images/Manager-Dater-page.png)
...
![Dater suspension confirmation dialog](images/Manager-Dater-suspend.png)
...
![Cupid management page showing registered cupids and their details](images/Manager-Cupid-page.png)
